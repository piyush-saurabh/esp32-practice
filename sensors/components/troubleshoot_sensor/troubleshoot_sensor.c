...
// Working: ADC1_CHANNEL_4 (GPIO32)
// PCB: ADC1_CHANNEL_6 (GPIO34)
#define LIGHT_SENSOR_GPIO ADC1_CHANNEL_6


#define TAG "TROUBLESHOOT_SENSOR"

//#define SENSOR_PIN 15

void troubleshoot_sensor(void *param)
{
    ...
    while(1)
    {
        ...
        // Capture raw data
        // GPIO 15
        //int raw_value = adc1_get_raw(LIGHT_SENSOR_GPIO);
